...
#[AsCommand(
    name: 'provision-unlock',
    description: 'Unlock a site or context'
)]
final class ProvisionUnlockCommand extends Command {
  ...
  protected function execute(InputInterface $input, OutputInterface $output): int {
    $this->manager->unlock((string) $input->getArgument('context'));
